...
- Total size: `131.1 TiB`
- Best size: `99.6 TiB`
- Alt size: `31.5 TiB`
- Realistic size: `102.7 TiB`
...
| 6    | Headpatter       | 3.7 TiB    | 3.1 TiB (83.88%)    | 113 (~33.3 GiB each)  |
...
| 42   | Erai-raws        | 631.1 GiB  | 84.2 GiB (13.34%)   | 37 (~17.1 GiB each)   |

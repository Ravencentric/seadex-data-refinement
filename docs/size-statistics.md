...
- Total size: `138.8 TiB`
- Best size: `105.5 TiB`
- Alt size: `33.3 TiB`
- Realistic size: `108.5 TiB`
...
| 4    | hchcsen          | 5.5 TiB    | 4.5 TiB (82.03%)    | 84 (~66.8 GiB each)   |
| 5    | Headpatter       | 4.5 TiB    | 3.5 TiB (77.19%)    | 145 (~32.0 GiB each)  |
...
| 50   | Others           | 45.4 TiB   | 24.6 TiB (54.28%)   | 2010 (~23.1 GiB each) |

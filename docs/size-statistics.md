...
- Total size: `129.2 TiB`
- Best size: `98.0 TiB`
- Alt size: `31.2 TiB`
- Realistic size: `101.5 TiB`
...
| 6    | Headpatter       | 3.4 TiB    | 2.9 TiB (84.99%)    | 103 (~34.0 GiB each)  |
| 7    | hchcsen          | 2.7 TiB    | 1.8 TiB (67.25%)    | 71 (~39.1 GiB each)   |
...
| 50   | Others           | 41.8 TiB   | 23.0 TiB (55.13%)   | 1889 (~22.6 GiB each) |
